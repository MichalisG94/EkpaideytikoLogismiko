...
public class DivTheoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_div_theory);
        ...
        String frameVideo = "<html><body>Video From YouTube<br><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/gT0HFbA1Mow\" frameborder=\"0\" allowfullscreen></iframe></body></html>";
        ...
        if(mFirebaseUser != null) {
            ...
            if(checkProfessor(mFirebaseUser)) {
                text1.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent i = new Intent(DivTheoryActivity.this, EditTheoryActivity.class);
                        i.putExtra("chapter", "Chapter 4");
                        i.putExtra("view", "View 1");
                        DivTheoryActivity.this.startActivity(i);
                        return true;
                    }
                });
            ...
            submitBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ref.child("Ratings").child("Theory").child("Chapter 4").child(UserId).child("Rating").setValue(rating);
                    finish();
                }
            });
        }
        ...
        ref.child("Ratings").child("Theory").child("Chapter 4").addListenerForSingleValueEvent(new ValueEventListener() {
            float totalRating;
            int counter = 0;
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                flipper.setInAnimation(DivTheoryActivity.this, R.anim.in_from_right);
                flipper.setOutAnimation(DivTheoryActivity.this, R.anim.out_to_left);
        ...
        prevBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                flipper.setInAnimation(DivTheoryActivity.this, R.anim.in_from_left);
                flipper.setOutAnimation(DivTheoryActivity.this, R.anim.out_to_right);
    ...
    protected void onResume() {
        ...
        textGet("Chapter 4", "View 1", text1);
        textGet("Chapter 4", "View 2", text2);
        textGet("Chapter 4", "View 3", text3);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch ( item.getItemId() ) {
            case R.id.helpIcon: {
                ...
                help(msgTitle, msg, DivTheoryActivity.this);
                return true;
            }
        }
